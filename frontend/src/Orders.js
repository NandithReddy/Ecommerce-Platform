...
function Orders() {
  ...
  useEffect(() => {
    ...
    fetch(`http://localhost:8082/api/orders?userId=${userId}`, {
      headers: {
  ...
  // After orders load, fetch product names
  useEffect(() => {
        ...
        <table className="table table-striped">
          <thead className="table-light">
            <tr>
              ...
              <th>Items</th>
              <th className="text-end" style={{ whiteSpace: 'nowrap' }}>Total</th>
              <th></th>
            </tr>
          </thead>
          <tbody>
